...
import { Download, FileDown, LogOut, Upload } from 'lucide-react';
    ...
    <AnimatePresence mode="wait" initial={false}>
      {view === 'main' ? (
        <motion.div
          ...
          className="min-h-screen bg-lifewood-paper p-4 md:p-8 text-lifewood-dark-serpent"
        >
        ...
        <motion.div
          ...
          className="relative min-h-screen overflow-hidden bg-[linear-gradient(135deg,#046241_0%,#FFB347_100%)] text-lifewood-dark-serpent"
        >
